	...
	const template = [
		...
		},
		{
			...
			submenu: [
				...
				{
					label: "Movement Ranges",
					click: () => {
						windows.send("renderer", "toggle", "movement_ranges");
					},
					type: "checkbox",
					checked: false,
				},
				{
					label: "Next Weapon Ranges",
					click: () => {
						windows.send("renderer", "toggle", "next_weapon_ranges");
					},
					type: "checkbox",
					checked: false,
				},
				...
				},
				{
					label: "Clusters",
					click: () => {
						windows.send("renderer", "toggle", "clusters");
					},
					type: "checkbox",
					checked: false,
				},
